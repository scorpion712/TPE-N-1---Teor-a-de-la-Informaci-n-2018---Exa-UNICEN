...
public class BmpHelper {
    ...
    public static void readBmpPixels() {

    }

    public static void writeBmpPixels() {
    ...
    /*
	// Obtain a sorted list of given images
    public static List<BmpImage> getSortedListOfImages(BmpImage original, List<BmpImage> images) {
        ...
        while (swapped) {
            swapped = false;
            discount++;
            for (int i = 0; i < images.size() - discount; i++) {
                if (BmpHelper.getCorrelationFactor(original, images.get(i)) < BmpHelper.getCorrelationFactor(original, images.get(i + 1))) {
                    tmp = images.get(i);
